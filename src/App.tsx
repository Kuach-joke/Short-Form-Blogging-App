...
const INITIAL_POSTS: Post[] = [
  {
    ...
    avatar: "MS",
    content:
      "The most underrated skill in writing is knowing what to cut. A sentence that almost works is worse than no sentence at all. Kill your darlings — not reluctantly, but with conviction. #writing #craft",
    timestamp: "2m",
    likes: 847,
    reposts: 203,
    replies: 41,
...

  {
    ...
    avatar: "DK",
    content:
      'Hot take: most "productivity systems" are elaborate procrastination dressed up as discipline. The people I know who get the most done don\'t have systems. They just start. #productivity',
    timestamp: "8m",
    likes: 1204,
    reposts: 519,
    replies: 87,
  ...
  },
  {
    ...
    avatar: "LB",
    content:
      "Just published my piece on how small city newspapers are being replaced by hyperlocal newsletters run by one person with a Substack account and an obsessive knowledge of municipal zoning. The future of local journalism might actually be weirder and better than we think. #journalism #localnews",
    timestamp: "23m",
    likes: 392,
    reposts: 88,
    replies: 29,
  ...
  },
  {
    ...
    avatar: "TV",
    content:
      "There's a specific kind of loneliness that comes from being in a room full of people who are all looking at their phones. We've normalized it so completely we don't even name it anymore. #culture #attention",
    timestamp: "41m",
    likes: 2817,
    reposts: 944,
    replies: 156,
  ...
  },
  {
    ...
    avatar: "PN",
    content:
      'Reminder that "move fast and break things" was always a power move by people who knew they wouldn\'t be the ones cleaning up. #tech #accountability',
    timestamp: "1h",
    likes: 4102,
    reposts: 1653,
    replies: 212,
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            {post.content.split(/(#\w+)/g).map((part, i) =>
              part.startsWith("#") ? (
                <span key={i} style={{ color: "#7c5cfc", cursor: "pointer" }}>
                  {part}
                </span>
              ) : (
                part
        ...
        >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    ...
                    >
                      {draft.length > 0 && (
                        <span
                          style={{ color: overLimit ? "#f04060" : "#52525e" }}
                        >
                          {overLimit
                    ...
                    >
                      {draft.length > 0 && (
                        <CharRing count={draft.length} limit={CHAR_LIMIT} />
                      )}
                      <button
                        onClick={handlePost}
                        ...
                        style={{
                          background:
                            !draft.trim() || overLimit ? "#2a2a31" : "#7c5cfc",
                          color:
                            !draft.trim() || overLimit ? "#52525e" : "#fff",
                          border: "none",
                          borderRadius: 20,
                          padding: "8px 20px",
                          fontFamily: "var(--font-body)",
          ...
          <aside style={{ padding: "24px 20px" }}>
              ...
              {TRENDING.map((item, i) => (
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    borderBottom:
                      i < TRENDING.length - 1 ? "1px solid #2a2a31" : "none",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "space-between",
                    cursor: "pointer",
            ...
            >
              ...
              >
                Every post is capped at 280 characters. Constraint breeds
                clarity. Say exactly what you mean — nothing more.
              </p>
